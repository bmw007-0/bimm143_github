...
- [Section 5: GO Online](#section-5-go-online)
...
```
    ...
    Info: Working in directory /Users/brianwong/Downloads/BIMM 143/bimm143_github/class14
...
The pathway that has the most significant “Entities p-value” is “Cell
Cycle, Mitotic”. Not quite, the significant pathways on the previous
KEGG results do not match completely to the significant pathways on
Reactome. A factor that could cause the differences between the two
methods are the different databases that these use to define their gene
ontologies. Another factor is the different correction and statisticaly
...
The pathway that has the most significant “Entities p-value” is “CENP-A
containnig chromatin assembly”. The significant pathways listed do not
match the previous KEGG results and the factors that cause this
difference could be explained like it was above with Reactome.
